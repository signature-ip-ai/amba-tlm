...
```
cd existing_repo
git remote add origin http://githost.marqueesemi.com:81/amba/amba-tlm.git
git branch -M main
...
- [ ] [Set up project integrations](http://githost.marqueesemi.com:81/amba/amba-tlm/-/settings/integrations)
